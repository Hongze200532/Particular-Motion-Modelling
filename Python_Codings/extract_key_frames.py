...
def main() -> None:
    ...
    target_root = script_dir / "Key_Outputs_image"

    jobs = [
        (script_dir / "Outputs_simulate" / "sim.gif", target_root / "Key_simulate"),
        (
            script_dir / "Outputs_pipeline" / "pipeline.gif",
